...
DROP POLICY IF EXISTS "Users can view books in their own lists" ON user_custom_list_books;
...
DROP POLICY IF EXISTS "Users can add books to their own lists" ON user_custom_list_books;
...
DROP POLICY IF EXISTS "Users can update books in their own lists" ON user_custom_list_books;
...
DROP POLICY IF EXISTS "Users can remove books from their own lists" ON user_custom_list_books;
...
CREATE INDEX IF NOT EXISTS idx_user_custom_list_books_list_id ON user_custom_list_books(list_id);
CREATE INDEX IF NOT EXISTS idx_user_custom_list_books_book_id ON user_custom_list_books(book_id);
