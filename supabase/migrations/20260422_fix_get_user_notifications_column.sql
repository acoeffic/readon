-- Fix: get_user_notifications referenced a.user_book_id which does not exist.
-- The activities table stores book info in payload JSONB, not in a user_book_id column.
-- This caused the RPC to fail with: "column a.user_book_id does not exist"
