-- Fix: activity_id is BIGINT in the notifications table but the function
-- declared it as INT, causing: "Returned type bigint does not match expected type integer in column 3"
