-- =====================================================
-- Migration: update RPC functions to exclude hidden books
-- + nouvelle fonction get_friend_recent_sessions
-- =====================================================

-- 1. Mise à jour de get_friend_profile_stats
--    Exclut les livres cachés des stats visibles par les amis
...
-- 2. Mise à jour de get_user_search_data
--    Exclut les livres cachés du current_book et du compteur books_finished
...
BEGIN
  ...
  -- Livre actuellement en cours (exclut les cachés)
  ...
  -- Nombre de livres terminés (exclut les cachés)
  SELECT COUNT(*)
...
-- 3. Nouvelle fonction : get_friend_recent_sessions
--    Retourne les sessions récentes d'un ami en excluant les livres cachés
