...
CREATE INDEX IF NOT EXISTS idx_reactions_activity_type ON reactions(activity_id, reaction_type);
...
DROP POLICY IF EXISTS "Premium users can insert reactions" ON reactions;
