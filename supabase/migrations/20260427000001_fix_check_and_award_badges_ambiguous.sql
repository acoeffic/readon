...
-- ambiguous "badge_id" between OUT parameter (RETURNS TABLE) and user_badges column.
-- Solution: #variable_conflict use_column → PL/pgSQL prefers column names over variables.
