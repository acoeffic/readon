...
CREATE INDEX IF NOT EXISTS idx_reading_goals_user_active ON reading_goals(user_id) WHERE is_active = TRUE;
...
DROP POLICY IF EXISTS "Users can delete own goals" ON reading_goals;
