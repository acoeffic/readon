...
-- 1. reading_goals.is_completed does NOT exist → hardcode 0 (like get_all_user_badges)
-- 2. comments uses author_id, not user_id
...
BEGIN
  ...
  -- FIX: comments uses author_id, not user_id
  ...
  -- FIX: reading_goals has no is_completed column
