            ...
            children: [
              ...
              Text(
                _matchedUsers.isEmpty
                    ? 'Aucun contact n\'utilise encore ReadOn'
                    : '${_matchedUsers.length} ami${_matchedUsers.length > 1 ? 's' : ''} trouvé${_matchedUsers.length > 1 ? 's' : ''} sur ReadOn',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
              ...
              if (_matchedUsers.isEmpty) ...[
                ...
                Text(
                  'Invite tes amis à rejoindre ReadOn !',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    color: isDark ? AppColors.textSecondaryDark : AppColors.textSecondary,
