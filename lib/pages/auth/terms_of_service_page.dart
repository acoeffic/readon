            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildSection(
                    '1. Objet',
                    'Les présentes Conditions Générales d\'Utilisation (ci-après les « CGU ») ont pour objet de définir les conditions dans lesquelles les utilisateurs (ci-après l\'« Utilisateur ») peuvent accéder et utiliser l\'application ReadOn (ci-après l\'« Application »).\n\nReadOn est une application de club de lecture social, permettant notamment de :\n• Suivre ses lectures,\n• Partager son activité de lecture,\n• Interagir avec d\'autres utilisateurs,\n• Participer à des défis, badges ou classements.\n\nToute utilisation de l\'Application implique l\'acceptation pleine et entière des présentes CGU.',
                  ),
                  _buildSection(
